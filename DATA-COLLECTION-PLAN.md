# Where Winds Meet - Data Collection Plan

## Purpose
This document outlines all the information needed to build a comprehensive companion app for Where Winds Meet.
...
## Priority 5: MEDIUM - Social & Multiplayer

### Guild System
- [ ] **Guild Creation**: Requirements, costs, management
- [ ] **Guild Activities**: Raids, events, rewards
- [ ] **Guild Perks**: Benefits of membership
- [ ] **Guild Levels**: Progression system

### Multiplayer Features
- [ ] **Dungeon List**: All dungeons, difficulty tiers, rewards
- [ ] **Raid Mechanics**: If raids exist, full guides
- [ ] **PvP Modes**: Arena, duels, ranked systems
- [ ] **Matchmaking**: How it works, ranking system
- [ ] **Trading System**: What can be traded, restrictions

---

## Priority 6: MEDIUM - Progression & Endgame

### Career System
- [ ] **Healer Career**: Complete skill tree, progression, best builds
- [ ] **Scholar Career**: Complete skill tree, progression, best builds
- [ ] **Career Benefits**: Specific advantages and abilities
- [ ] **Career Switching**: If possible, costs and mechanics

### Endgame Content
- [ ] **Endgame Activities**: List of max-level content
- [ ] **Legendary Weapons**: Special weapon quests and requirements
- [ ] **Prestige Systems**: Post-max-level progression
- [ ] **Weekly Lockouts**: Reset schedules for raids/dungeons
- [ ] **Leaderboards**: Ranking systems and rewards

---

## Priority 7: LOWER - Cosmetics & Monetization

### Cosmetic Database
- [ ] **All Cosmetic Items**: Complete catalog with images
- [ ] **Pricing Information**: Real money costs
- [ ] **Acquisition Methods**: Store, battle pass, achievements
- [ ] **Battle Pass Contents**: All rewards per season
- [ ] **Limited-Time Items**: Event exclusives, seasonal content

### Economy
- [ ] **Premium Currency**: Pricing tiers, best value packs
- [ ] **In-Game Economy**: Gold farming methods, sinks
- [ ] **Trading Prices**: Market values for tradeable items
- [ ] **Daily/Weekly Rewards**: Free rewards schedule

---

## Priority 8: LOWER - Community & Guides

### Player Resources
- [ ] **Optimal Leveling Routes**: 1-max level efficiently
- [ ] **Gold Farming Guides**: Best methods per level range
- [ ] **Material Farming Routes**: Efficient gathering paths
- [ ] **Achievement Guides**: How to complete all achievements
- [ ] **Secret Hunting**: Hidden content discovery guide

### Meta Information
- [ ] **Tier Lists**: Rankings for weapons, skills, builds
- [ ] **Patch Notes History**: Changes over time
- [ ] **Community Builds**: Popular player-created builds
- [ ] **Speedrun Routes**: For story and dungeons
- [ ] **Challenge Run Ideas**: Self-imposed challenges
...
### Official Sources
1. **Official Website**: https://www.wherewindsmeetgame.com/
2. **Official Social Media**: Twitter, Facebook, Discord
3. **Developer Blogs**: NetEase and Everstone Studios
4. **Patch Notes**: Official update announcements
5. **Official Wiki**: If one exists

### Community Sources
1. **Fextralife Wiki**: https://wherewindsmeet.wiki.fextralife.com/
2. **Game8 Guide**: https://game8.co/games/Where-Winds-Meet/
3. **Fandom Wiki**: https://where-winds-meet.fandom.com/
4. **Reddit**: r/wherewindsmeet (if exists)
5. **Discord Communities**: Player-run servers
6. **YouTube**: Guide creators, content creators
7. **Twitch**: Streamers with game knowledge
8. **Steam Community**: Guides, discussions, screenshots

### In-Game Data Collection
1. **Screenshot Everything**: Skills, stats, items, maps
2. **Record Gameplay**: Combos, boss fights, animations
3. **Spreadsheet Tracking**: Personal data gathering
4. **Collaboration**: Multiple players gathering different data

### Tools Needed
1. **Database System**: Store all collected information
2. **Image Repository**: Screenshots and reference images
3. **Video Repository**: Combat footage, guides
4. **API Access**: If the game has a public API
5. **Data Mining Tools**: If legally permitted

---

## Companion App Features to Consider

### Core Features
- [ ] **Build Calculator**: Plan character builds
- [ ] **Skill Database**: Searchable skill information
- [ ] **Map with Markers**: Interactive world map
- [ ] **Quest Tracker**: Track completed/available quests
- [ ] **Item Database**: Search all items
- [ ] **Character Planner**: Plan progression path

### Advanced Features
- [ ] **Build Sharing**: Share builds with community
- [ ] **News Feed**: Latest updates and patches
- [ ] **Event Timer**: Track world bosses, events
- [ ] **Damage Calculator**: Calculate DPS
- [ ] **Loot Tracker**: Track what you need
- [ ] **Achievement Checklist**: Track completion
- [ ] **Guild Management**: Coordinate with guild
- [ ] **Trading Hub**: Find trade partners

### Social Features
- [ ] **Community Builds**: User-submitted builds
- [ ] **Build Voting**: Rate popular builds
- [ ] **Discussion Forums**: In-app community
- [ ] **Player Profiles**: Track personal progress
...
1. **Set Up Data Collection Infrastructure**
   ...
   - Organize file structure (already done)
   - Set up image storage
   - Create video repository

2. **Begin Systematic Data Gathering**
   - Start with Priority 1 items
   - Document as you play
   - Collaborate with other players
   - Monitor community wikis

3. **Verify Information**
   - Cross-reference multiple sources
   - Test mechanics in-game
   - Update as patches change data
   - Mark uncertain information

4. **Build API/Database**
   - Structure data for app use
   - Create JSON files or database
...
- **Daily**: Check for new community discoveries
- **Weekly**: Review patch notes, update changed information
- **Monthly**: Audit data accuracy, fill gaps
- **Per Season**: Battle pass content, new features
