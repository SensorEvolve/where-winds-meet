...
**Mix & Match**: Players can use multiple weapon types
**Switching**: Change weapons during combat
...
**Playstyle**: Balanced, versatile combat

**Characteristics**:
- Traditional wuxia weapon
- Balanced offense and defense
- Fluid combos
- Good for beginners
- Likely moderate attack speed and damage
...
**Playstyle**: Reach and piercing attacks

**Characteristics**:
- Extended range
- Thrust-focused attacks
- Crowd control potential
- Keep enemies at distance
...
**Characteristics**:
- Extended reach with projectile element
- High mobility potential
- Complex to master
- Rapid attacks possible
...
**NEEDED INFORMATION**:
- Complete weapon list with all variants
- Weapon stat tables
- Martial Arts skills for each weapon type
- Weapon acquisition locations
- Crafting recipes and requirements
- Upgrade paths and material costs
- Best-in-slot weapons for each build
- Weapon combos and movesets
- Special weapon effects and procs
- Legendary weapon list with unique abilities
- Weapon scaling with character stats
- Two-weapon system mechanics (if applicable)
- Weapon swap speed and combat flow
- Hidden or secret weapons
